...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Implemented backend and supporting infrastructure in C++ with gRPC and cohesive automated testing.}
      \resumeItem{Designed and presented potential project implementations with stakeholders.}
      \resumeItem{Impacted adjacent teams and clients by implementing the backend to a one-stop site to display crucial metrics and ML services.}
    \resumeItemListEnd
    \resumeSubHeadingListEnd

\resumeSubHeadingListStart
  \resumeSubheading
    {Tokyo Coding Club }{Jun 2021 -- Present}
...
\textbf{Misc:} CFA LV 1, NLP, AI, API design, systems design, software architecture, equities, Seinfeld
}
