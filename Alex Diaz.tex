...
\begin{itemize}
  ...
  \item {\small \textbf{\textit{2020 -- TimeTime} --} I programmed a Java Android application that prompts users through their lockscreen to log their daily activities. The application uses a model-view-controller pattern to provide users an infinite scrolling list and enable interactions with good performance. My architecture allowed for local persistent data and concurrency.}
