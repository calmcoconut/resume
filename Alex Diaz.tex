...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    \resumeItemListStart[topsep=0pt,itemsep=0pt,parsep=0pt,before=\vspace{0cm},after=\vspace{1mm}] % added option to save space
...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Assembled and developed automated data reporting for executive leadership in US sales territories with \textbf{SQL}, \textbf{Python's Pandas}, and \textbf{Power BI}}
      \resumeItem{Led inter-team coordination to automate reporting practices. Reduced daily reporting workloads from 3 hours to 3 minutes by automating reports using Python and Microsoft \textbf{VBA} with \textbf{SQL} database}
      \resumeItem{Implemented SQL server database jobs to minimizing manual maintenance and reporting requirements}
      \resumeItem{Addressed production bugs and made improvements in existing inter-team reporting in \textbf{Python}, \textbf{VBA}, and \textbf{SQL}. Eliminated consistent negative feedback logs for in-production reports}
    \resumeItemListEnd
    \resumeSubHeadingListEnd
...
\section{Projects}
\textbf{Raven's Progressive Matrices (RPM) AI agent}
