...
\begin{itemize} \setlength\itemsep{-0.3em}
    \item Developed Python based CLI tool, to coordinate Data and ETL job migrations between Hadoop data centres (Tool touchpoints - Apache Hue, Oozie API, HDFS API, DistCP utils, Several Postgres DBs, Grafana dashboards, Data quality portals and several internal tools).
...
\begin{tabular}{ l l }
    ...
    \\
    BigData tooling:            & Hadoop, Cassandra, RedShift, Hadoop, Hive, Impala, Spark, Hue         
    \\
    ...
    Application monitoring:     & New relic, Grafana, Kibana, Sentry, AWS Cloudwatch, Sensu
    \\
